...
main (void)
{
  ...
  while (scanf ("%d", &n) == 1)
    {				//if successfully read in ONE decimal integer
 ...
 * */
void
flipBits (char arr[], int numOfBits)
{
 ...
 * */
void
magnitudeToBinary (int n, char arr[], int numOfBits)
{
  //Implement the division-remaider algorithm here

  for (int i = numOfBits - 1; n > 0; i--)
    {
      if (i >= 0)
	{
